...
module Walrus
  ...
  class StringProcessingErrorTest < Test::Unit::TestCase
    ...
    def test_new
      ...
      assert_nothing_raised do
        error = StringProcessingError.new(nil, "filename", nil, 0)
      end
      ...
      assert_nothing_raised do
        error = StringProcessingError.new(nil, "filename", 0, nil)
      end
      assert_not_nil error
      assert_equal "filename", error.filename
      ...
      assert_nothing_raised do
        error = StringProcessingError.new(nil, "filename", nil, nil)
      end
      assert_not_nil error
      assert_equal "filename", error.filename
      assert_nil error.line_number
      ...
      error = nil
      assert_nothing_raised do
        error = StringProcessingError.new(nil, "filename", 0, 0)
      end
      assert_not_nil error
      assert_equal "filename", error.filename
      assert_equal 0, error.line_number
      ...
      assert_nothing_raised ArgumentError do
        error = StringProcessingError.new(nil, nil, 0, 0)
      end
      assert_not_nil error
      ...
      error = StringProcessingError.new(nil, "filename", 25, 60)
      assert_equal "filename", error.filename
    ...
    def test_to_s
      ...
      # non-nil filename
      error = StringProcessingError.new(nil, "filename", 25, 60)
      assert_equal "Walrus::StringProcessingError at filename:25:60", error.to_s
    
      # nil filename
      error.filename = nil
      assert_equal "Walrus::StringProcessingError at 25:60", error.to_s
    
      # now with optional message included
      error = StringProcessingError.new("fatal err", "filename", 25, 60)
      assert_equal "fatal err (Walrus::StringProcessingError at filename:25:60)", error.to_s
    
      error.filename = nil
      assert_equal "fatal err (Walrus::StringProcessingError at 25:60)", error.to_s
    
      # now with nil line number
      error.line_number = nil
      assert_equal "fatal err (Walrus::StringProcessingError at ?:60)", error.to_s
    
      # and nil column number
      error.column_number = nil
      assert_equal "fatal err (Walrus::StringProcessingError at ?:?)", error.to_s
    
    end  
  
  end # class StringProcessingErrorTest
end # module Walrus
